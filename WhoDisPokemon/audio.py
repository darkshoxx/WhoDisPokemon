...
def combine_audio_and_video(video_path=WTP_ANSWER_VID,
                            audio_path=WTP_ANSWER_NAME,
                            export_path=WTP_ANSWER_NAME_VIDEO
                            ):
...
def create_question_video(export_path):
    ...
    combine_audio_and_video(WTP_QUESTION_VID,
                            WTP_QUESTION,
                            WTP_QUESTION_VIDEO_AUDIO
                            )
...
if __name__ == "__main__":
    ...
    create_answer_video(bg_path=WTP_ANSWER,
                        pokename_path=WTPIKACHU,
                        video_path=WTP_ANSWER_VID,
                        export_path=WTP_ANSWER_NAME_VIDEO
                        )
